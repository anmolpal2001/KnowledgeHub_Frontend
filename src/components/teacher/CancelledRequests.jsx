...
const CancelledRequests = () => {
    const {fetchCancelledSessions,cancelledSessions,error,loading,formatDate} = SessionContextApi();
    useEffect(() => {
  ...
  return (
    <div>
      ...
      <h1 className="mb-4 text-2xl font-bold leading-none tracking-tight text-gray-900 md:text-4xl lg:text-5xl dark:text-white">Cancelled Request's List</h1>
                ...
                {cancelledSessions.length === 0 ? (
                  <tbody>
                    <tr className="bg-white dark:bg-gray-800 text-center">
                        <td className="px-4 py-3" colSpan="6">
                            {loading ? error ? error : "Loading..." : "No cancelled sessions found"}
                        </td>
                    </tr>
                  </tbody>
                ) : (
                  <tbody>
                    {cancelledSessions.map((session) => (
                      <tr key={session._id} className="bg-white dark:bg-gray-800">
