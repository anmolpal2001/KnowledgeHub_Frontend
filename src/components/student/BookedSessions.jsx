...
const BookedSessions = () => {
    const {bookedSessions,fetchBookedSessions,formatDate,loading,error} = SessionContextApi();
    useEffect(() => {
      fetchBookedSessions();
    }, []);
  ...
  return (
    <div className="flex justify-center flex-col items-center mt-20">
      <h1 className="mb-4 text-2xl font-bold leading-none tracking-tight text-gray-900 md:text-4xl lg:text-5xl dark:text-white">Booked Session's List</h1>
                  ...
                  <tbody>
                    <tr className="bg-white dark:bg-gray-800 text-center">
                        <td className="px-4 py-3" colSpan="6">
                            {loading ? error ? error : "Loading..." : "No Booked Sessions"}
                        </td>
                    </tr>
                  </tbody>
                ) : (
